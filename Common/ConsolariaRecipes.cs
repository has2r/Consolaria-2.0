...
sealed class ConsolariaRecipes : ModSystem {
    ...
    private void AddThoriumRecipes1(Recipe item) {
        Mod thoriumMod = ModLoader.GetMod(ThoriumCompat.THORIUMMODNAME);
    ...
    [JITWhenModsEnabled(ThoriumCompat.THORIUMMODNAME)]
    private void AddThoriumRecipes2(Recipe item, Recipe temp) {
        Mod thoriumMod = ModLoader.GetMod(ThoriumCompat.THORIUMMODNAME);
        // thrower
    ...
    [JITWhenModsEnabled(ThoriumCompat.THORIUMMODNAME)]
    private void AddThoriumRecipes3(Recipe item, Recipe temp) {
        Mod thoriumMod = ModLoader.GetMod(ThoriumCompat.THORIUMMODNAME);
        // thrower
    ...
    public override void AddRecipes() {
        ...
        string thoriumModName = ThoriumCompat.THORIUMMODNAME;
        if (ModLoader.HasMod(thoriumModName)) {
            AddThoriumRecipes1(item);
        }
