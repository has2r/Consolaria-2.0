...
namespace Consolaria.Content.Items.Armor.Ranged
{
    ...
    public class TitanMail : ModItem
    {
        ...
        public override void SetStaticDefaults() {
            ...
            if (!Main.dedServ) {
                mailGlowmask = ModContent.Request<Texture2D>(Texture + "_Glow");
                BodyGlowmask.RegisterData(Item.bodySlot, () => new Color(255, 255, 255, 0) * 0.8f * 0.75f);
            }
        }

        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
            => Item.BasicInWorldGlowmask(spriteBatch, mailGlowmask.Value, new Color(255, 255, 255, 0) * 0.8f * 0.75f, rotation, scale);
