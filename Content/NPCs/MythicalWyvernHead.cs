...
namespace Consolaria.Content.NPCs
{
	public class MythicalWyvernHead : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			if (SeasonalEvents.enabled) return SeasonalEvents.isChineseNewYear ? SpawnCondition.Sky.Chance * 0.05f : 0f;
			else return LanternNight.LanternsUp ? SpawnCondition.Sky.Chance * 0.05f : 0f;
		}
	}
}