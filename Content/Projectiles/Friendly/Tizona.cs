    ...
    public class Tizona : ModProjectile {
        ...
        private void SwingAI () {
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
                Dust.NewDustPerfect(position, DustID.Shadowflame, velocity * 1f, 100, Color.White * Projectile.Opacity, 1.2f * Projectile.Opacity);
        ...
        private void DrawLikeExcalibur (SpriteBatch spriteBatch) {
            ...
            float fromValue = Lighting.GetColor(Projectile.Center.ToTileCoordinates()).ToVector3().Length() / (float) Math.Sqrt(3.0);
            fromValue = Utils.Remap(fromValue, 0.2f, 1f, 0f, 1f);
            Color value = Color.Lerp(new Color(95, 70, 135), new Color(115, 80, 145), amount); //near sword
            ...
            Color value2 = Color.Lerp(new Color(65, 60, 130), new Color(75, 70, 140), amount); //central part
            Color color = Color.Lerp(new Color(130, 120, 220), new Color(100, 90, 200), amount); //main color
            ...
            spriteBatch.Draw(texture, vector, texture.Frame(1, 4, 0, 3), Color.Red * 0.6f * num3, Projectile.rotation + Projectile.ai [0] * 0.01f, origin, num, effects, 0f);
            ...
            DrawHelper.DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos2, new Color(255, 0, 0) * num3 * 0.5f, color, num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * scaleFactor, Vector2.One * scaleFactor);
        }
